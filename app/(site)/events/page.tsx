...
const FLAGSHIPS: Flagship[] = [
  ...
  },
  {
    ...
    body: <>Two days of live demonstrations — civil scale-models, electrical control panels, mechanical CAD outputs, computer-science software projects. Open to schools, parents and visitors.</>,
    date: "21–22 February",
    pillTone: "accent",
    img: BIPE_IMG.projectFair,
    imgLabel: "TECHNOFEST · PROJECT FAIR",
    side: "right",
    tags: ["Civil models", "Electrical", "CAD", "Software"],
  },
  {
    hi: "स्पर्धा",
    en: "Spardha",
