    ...
    <div className="page-enter">
      ...
      <section className="section" style={{ position: "relative", overflow: "hidden", paddingTop: 72, paddingBottom: 72 }}>
        ...
        <div className="container" style={{ position: "relative" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.25fr 1fr", gap: 64, alignItems: "center" }}>
            <div>
            ...
            {/* Image collage */}
            <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gridTemplateRows: "1fr 1fr", gap: 14, height: 540 }}>
      ...
      <section className="section" style={{ background: "var(--ink)", color: "var(--paper)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 64, alignItems: "center" }}>
            <div>
              <div className="eyebrow" style={{ color: "var(--accent)" }}>§ Governance</div>
              <div style={{
                fontFamily: "var(--font-serif)", fontStyle: "italic", fontWeight: 400,
              ...
              <p className="serif" style={{
                ...
                lineHeight: 1.2, color: "var(--paper)",
                fontStyle: "italic", fontWeight: 400, letterSpacing: "-0.015em",
                maxWidth: "20ch",
              }}>
                BIPE was established in 2010 to{" "}
                <span style={{ color: "var(--accent)" }}>facilitate quality technical education</span>{" "}
                to serve rural society.
              </p>
              <div style={{
                ...
                Dr. Chandrika Rai · Chairman Trustee · IPS (Retd)
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div style={{
                ...
                <div className="eyebrow" style={{ color: "var(--accent)" }}>Chairman Trustee</div>
                <div style={{ marginTop: 8, fontWeight: 600, fontSize: 18 }}>Dr. Chandrika Rai</div>
                <div style={{ fontSize: 13, color: "color-mix(in oklab, var(--paper) 65%, transparent)", marginTop: 4 }}>
                  IPS (Retd) · Purwanchal Educational Trust
                </div>
              </div>
              <div style={{
                padding: 26, borderRadius: 18,
                ...
                <div className="eyebrow" style={{ color: "var(--accent)" }}>Principal</div>
                <div style={{ marginTop: 8, fontWeight: 600, fontSize: 18 }}>Rahul Srivastava</div>
                <div style={{ fontSize: 13, color: "color-mix(in oklab, var(--paper) 65%, transparent)", marginTop: 4 }}>
                  M.Tech · Day-to-day academic & operational lead
                </div>
                <a href="mailto:principal@bipevns.org" style={{ display: "inline-block", marginTop: 12, color: "var(--accent)", fontFamily: "var(--font-mono)", fontSize: 12, letterSpacing: "0.06em" }}>
              ...
              <Link href="/approvals" style={{
                ...
                <span>Read the full Mandatory Disclosure</span>
                <ArrowIcon size={16} />
              </Link>
            </div>
          </div>
