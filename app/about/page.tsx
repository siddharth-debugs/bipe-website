          ...
          <div className="bipe-split" style={{ display: "grid", gridTemplateColumns: "1.25fr 1fr", gap: 64, alignItems: "center" }}>
            <div>
              ...
              <p className="lead" style={{ marginTop: 22, maxWidth: "52ch" }}>
                A six-acre AICTE-approved polytechnic in Varanasi, with its campus in Phoolpur. Four BTEUP-affiliated branches, 550+ students drawn from twelve districts, 40 faculty &mdash; built to make rural India a credible address for technical education.
              </p>
        ...
        <div className="container" style={{ position: "relative" }}>
          <div className="bipe-split" style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 80 }}>
            ...
            <div style={{ color: "var(--ink-2)", fontSize: 16.5, lineHeight: 1.75, maxWidth: "62ch" }}>
              ...
              <p style={{ marginTop: 18 }}>
                We run <em>four</em> BTEUP-affiliated branches — <strong style={{ color: "var(--brand)" }}>Civil, Electrical, Mechanical Engineering (Production) and Computer Science &amp; Engineering</strong> — taught in an eight-section workshop, a 120-system computer lab and our own survey yard. Civil and Mechanical Engineering (Production) alumni work on Smart Cities, Bharatmala alignments and the Kashi Vishwanath corridor. Computer Science &amp; Engineering graduates clear B.Tech entrances; Electrical graduates write SSC JE and RRB JE.
              </p>
              <p style={{ marginTop: 18 }}>
        ...
        <div className="container" style={{ position: "relative" }}>
          <div className="bipe-split" style={{ display: "grid", gridTemplateColumns: "auto 1fr", gap: 32, alignItems: "end", marginBottom: 36, paddingBottom: 22, borderBottom: "1px solid var(--line)" }}>
            ...
            <p style={{ color: "var(--ink-2)", maxWidth: "44ch", justifySelf: "end", textAlign: "right" }}>
              The 2026-27 sanctioned intake under JEECUP college code 4455 — four 3-year BTEUP-affiliated diploma courses, <strong style={{ color: "var(--ink)" }}>{totalSeats} seats</strong>.
            </p>
          </div>
          ...
          <div className="card" style={{ padding: 0, overflow: "hidden", maxWidth: 980, margin: "0 auto" }}>
            ...
            <div style={{
              ...
              <div style={{ fontWeight: 700, fontSize: 15, color: "var(--ink)" }}>2026-27 sanctioned intake · 4 BTEUP branches</div>
              <div className="serif" style={{
