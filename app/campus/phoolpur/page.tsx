...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Confirm your visit on WhatsApp (+91-9005882866) and BIPE will share the campus pin and easiest route. An app-cab (Ola / Uber) or pre-paid auto from the station auto-stand reaches Phoolpur in about 35 minutes off-peak — roughly ₹300-500.",
  },
  {
