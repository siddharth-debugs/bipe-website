          ...
          <div style={{ position: "relative", overflow: "hidden", borderRadius: 28, border: "1px solid var(--line)", background: "var(--white)", padding: "48px 48px" }}>
            ...
            <div className="bipe-split" style={{ position: "relative", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 48, alignItems: "center" }}>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                ...
                <a href="https://wa.me/919005882866?text=Hi%20BIPE%20%E2%80%94%20I%20am%20comparing%20government%20polytechnic%20options%20against%20BIPE.%20Can%20you%20help%20me%20decide%3F" target="_blank" rel="noopener noreferrer" className="btn btn-lg" style={{ background: "var(--accent)", color: "var(--ink)", justifyContent: "space-between" }}>
