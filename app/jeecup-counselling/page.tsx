...
const CHOICE_TIPS: string[] = [
  ...
  "Then list every BIPE branch you'd accept, in your preference order. BIPE-Civil → BIPE-Electrical → BIPE-Mechanical Production → BIPE-CSE.",
        ...
        <div className="container">
          ...
          >
            ...
            <p style={{ marginTop: 16, color: "var(--ink-2)", fontSize: 14, fontStyle: "italic" }}>
              This locks BIPE as your institute as long as ANY of the four branches has a
