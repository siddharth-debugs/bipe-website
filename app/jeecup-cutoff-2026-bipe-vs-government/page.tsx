          ...
          <div style={{ position: "relative", overflow: "hidden", borderRadius: 28, border: "1px solid var(--line)", background: "var(--white)", padding: "48px 48px" }}>
            ...
            <div className="bipe-split" style={{ position: "relative", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 48, alignItems: "center" }}>
              ...
              <div style={{ display: "grid", gap: 12 }}>
                <a href="https://wa.me/919198646464?text=Hi%20BIPE%20%E2%80%94%20My%20JEECUP%202026%20rank%20is%20%5Brank%5D%2C%20I%20want%20to%20discuss%20whether%20government%20or%20BIPE%20fits%20best." target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-lg" style={{ justifyContent: "space-between" }}>
