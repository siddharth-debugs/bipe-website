      ...
      <section className="section" style={{ background: "var(--brand)", color: "#fff" }}>
        <div className="container" style={{ maxWidth: 820, textAlign: "center" }}>
          ...
          <p style={{ marginTop: 12, opacity: 0.9, lineHeight: 1.7 }}>
            Call +91-9198646464 or WhatsApp +91-9198767676 (separate handset for chat). Our counsellors are familiar with the Bihar Board, JEECUP all-India quota and the practicalities of moving a child from Patna, Ara, Buxar, Sasaram or Gaya to the BIPE campus.
          </p>
