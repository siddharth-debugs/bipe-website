...
const FAQS: { q: string; a: string }[] = [
  {
    ...
    a: "JEECUP Group A (Polytechnic Engineering) is open to anyone who has passed Class 10 with Mathematics and Science. There is no upper age limit for most Group A polytechnic seats. Domicile is not restricted to UP — students from Bihar, Jharkhand, MP and elsewhere can apply and are admitted in the open / general category (no UP domicile certificate is required for a private polytechnic like BIPE). BIPE specifically admits via JEECUP institute code 4455, across four BTEUP branches — Civil, Electrical, Mechanical Engineering (Production) and Computer Science & Engineering.",
  },
  {
    q: "What is BIPE's JEECUP institute code?",
    a: "4455. You enter this code during the JEECUP counselling choice-filling round to add BIPE to your preference list — once for each branch you want to consider. Many applicants add 4455 against all four branches — Civil, Electrical, Mechanical Engineering (Production) and Computer Science & Engineering — in case their rank doesn't reach their first choice.",
  },
  {
  ...
  // ─── Hindi vernacular Q&As — same audience cluster as /fees page ───
  {
    ...
    a: "JEECUP Group A (Polytechnic Engineering) के लिए Class 10 pass with Math + Science चाहिए। कोई upper age limit नहीं। UP domicile आवश्यक नहीं — Bihar, Jharkhand, MP और बाकी राज्यों से भी open / general category में apply कर सकते हैं (BIPE जैसे private polytechnic में admission के लिए UP domicile certificate ज़रूरी नहीं)। BIPE की admission JEECUP institute code 4455 से होती है — चार BTEUP branches के लिए: Civil, Electrical, Mechanical (Production) और Computer Science & Engineering।",
  },
  {
    q: "BIPE का JEECUP code क्या है और कैसे इस्तेमाल करें?",
    a: "BIPE का JEECUP institute code 4455 है। Counselling के choice-filling round में इसी code से BIPE को add करना होता है। चारों branches के लिए 4455 ही code है — branch अलग से select होती है। ज़्यादातर applicants चारों branches (Civil, Electrical, Mechanical (Production), Computer Science & Engineering) के सामने 4455 add कर देते हैं, ताकि rank कम होने पर भी कोई एक branch मिल जाए।",
  },
  {
      ...
      <section className="section" style={{ background: "var(--ink)", color: "var(--paper)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative" }}>
          ...
          <p style={{ marginTop: 22, textAlign: "center", maxWidth: "72ch", marginInline: "auto", fontSize: 13.5, lineHeight: 1.7, color: "color-mix(in oklab, var(--paper) 66%, transparent)" }}>
            All four branches run the same six-semester BTEUP calendar and the same ₹30,150 AFRC tuition — taught across an eight-section workshop, a 120-system computer lab, the civil survey yard and the branch labs, and closing with the mandatory six-month industrial training in Semester 6.
          </p>
