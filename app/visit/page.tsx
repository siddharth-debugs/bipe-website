  ...
  return (
    <div className="page-enter">
      ...
      <section className="section" style={{ background: "var(--ink)", color: "var(--paper)", position: "relative", overflow: "hidden" }}>
        ...
        <div className="container" style={{ position: "relative" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 56, alignItems: "start", marginBottom: 40 }}>
            <div>
      ...
      <section className="section" style={{ background: "var(--ink)", color: "var(--paper)", position: "relative", overflow: "hidden", paddingTop: 96, paddingBottom: 96 }}>
        ...
        <div className="container" style={{ position: "relative", textAlign: "center" }}>
          ...
          <p style={{ marginTop: 28, color: "color-mix(in oklab, var(--paper) 80%, transparent)", fontSize: 17, lineHeight: 1.7, maxWidth: "60ch", margin: "28px auto 0" }}>
            We&apos;ve watched hundreds of families decide on the diploma here on a 90-minute walk. The campus tells you things a brochure can&apos;t — the smell of the welding shop, the rhythm of the dairy plant, the look on a student&apos;s face when they explain what they&apos;re building. Come and see for yourself.
          </p>
