      ...
      <div className="nav-utility">
        <div className="nav-utility-inner">
          <div className="nav-utility-left">
            ...
            <span className="nav-utility-divider" />
            <span style={{ textTransform: "uppercase", color: "var(--paper)", fontWeight: 600 }}>Classes start 15 July</span>
          </div>
        ...
        <div className="nav-links primary">
          ...
          >
            ...
            <div className="nav-mega-grid">
              ...
              <MegaItem to="/early-registration" title="Early Seat Registration" desc="JEECUP 2026 · branch + ₹1,200 scholarship" icon="M9 11l3 3L20 5M21 12v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h9" />
      ...
      >
        ...
        <div className="nav-drawer-cta">
          ...
          <Link href="/early-registration" className="btn btn-sm" onClick={() => setDrawerOpen(false)}
            ...
            JEECUP 2026 · Early Seat Registration →
          </Link>
