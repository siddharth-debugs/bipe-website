        ...
        <div className="nav-links primary">
          ...
          >
            ...
            <div className="nav-mega-grid">
              ...
              <MegaItem to="/early-registration" title="Admissions Enquiry" desc="JEECUP 2026 counselling concluded · classes on" icon="M9 11l3 3L20 5M21 12v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h9" />
