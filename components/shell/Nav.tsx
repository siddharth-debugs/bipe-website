        ...
        <div className="nav-links primary">
          ...
          >
            ...
            <div className="nav-mega-grid">
              ...
              <MegaItem to="/early-registration" title="Pre-Counselling Registration" desc="JEECUP 2026 · reserve branch + ₹1,200 scholarship" icon="M9 11l3 3L20 5M21 12v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h9" />
