...
export const BRANCH_DETAIL: Record<string, BranchDetail> = {
  ...
  "dairy-engineering": {
    // Rewritten 3 Sep 2026 for the admissions closure. `intro` is doing two
    // jobs — it is the hero lead on /courses/dairy-engineering AND the
    // `description` of that page's Course JSON-LD, so it is the sentence an
    // AI answer or a rich result is most likely to quote back at somebody
    // choosing branches. It therefore has to carry the closure itself, not
    // rely on the notice banner the page renders around it. What stays:
    // the "one of only four in UP" fact (true), the curriculum, the labs,
    // the Banas Dairy visits and the recruiter names (the enrolled cohort
    // is still heading for those roles). What went: "career options that
    // simply don't exist for graduates of other branches" — that was a
    // reason-to-pick-this-branch line and there is no longer a branch to
    // pick.
    intro:
      "The Diploma in Dairy Engineering at BIPE (also called Dairy Technology at degree level — the diploma board uses 'Engineering') is a 3-year, 6-semester BTEUP programme, code 327, AICTE-approved, and one of only four of its kind affiliated anywhere in Uttar Pradesh. It is closed to new admissions from 2026-27: the last intake was 2025-26, and that cohort is being taught out to its 2028 graduation with teaching, labs, industrial visits and the mandatory six-month Semester-6 industrial training all running unchanged. The curriculum covers milk processing, dairy machinery, refrigeration, microbiology and quality assurance, taught through BIPE's on-campus chemistry, hydraulics and mechanics labs plus structured industrial visits to working dairy plants such as Banas Dairy Varanasi. It qualifies the students holding it for plant, quality-control and Junior Engineer roles at Amul, Mother Dairy, Parag, Nestlé, NDDB and the State Dairy Boards.",
    semesterThemes: [
    ...
    labs: [
      { name: "Industrial visits to working dairy plants", body: "Structured cohort visits to active dairy plants — most recently Banas Dairy Plant Varanasi — give students floor-time on real pasteurisers, separators, homogenisers, storage silos and capping/packaging lines. Plant unit operations from the BTEUP syllabus are taught on actual production machinery, not lab models. BIPE does not run its own pilot plant; the visits are how dairy unit-operation exposure happens." },
      { name: "Dairy microbiology & chemistry lab", body: "Standard plate counts, antibiotic residue tests, lactometer and fat-percentage analysis — the FSSAI-aligned analytical curriculum is taught in BIPE's on-campus chemistry lab." },
      { name: "Hydraulics & process-fluid lab", body: "BIPE's hydraulics lab (BIPEHYD/201 series rigs — pumps, control valves, delivery pipes) supports the Semester 3 fluid mechanics module and the unit operations that move milk through a real plant — flow, pressure, valve control." },
    ],
    careers: [
    ...
    // FAQ order matters twice over: it is the on-page accordion order and the
    // mainEntity order of the FAQPage JSON-LD, and Google most often lifts the
    // first entry. So the "can I still take admission" answer leads — that is
    // the question a 15-year-old with a JEECUP choice list actually has, and
    // getting it wrong costs them a seat. 3 Sep 2026.
    faqs: [
      { q: "Can I still take admission in Dairy Engineering at BIPE?", a: "No. Dairy Engineering (BTEUP 327) took its last intake in the 2025-26 session and is closed to new admissions from 2026-27, so do not list it as a choice for BIPE in JEECUP counselling. For 2026-27 BIPE admits to four branches — Civil Engineering, Electrical Engineering, Mechanical Engineering (Production) and Computer Science & Engineering, 420 seats between them — under JEECUP institute code 4455. The students already enrolled in Dairy Engineering continue on campus and graduate in 2028." },
      { q: "Is Dairy Engineering at BIPE BTEUP 327?", a: "Yes — Dairy Engineering at BIPE is BTEUP code 327, one of only four programmes of its kind affiliated in Uttar Pradesh. It is no longer open to new admissions: the last intake was 2025-26 and that cohort completes the code-327 curriculum in 2028. BIPE's four admitting branches take students through JEECUP institute code 4455." },
      { q: "What's the difference between Dairy Engineering and Dairy Technology?", a: "Dairy Engineering (BTEUP 327) is a 3-year diploma after Class 10, focused on the machinery, processing and plant operation side. Dairy Technology is typically a longer degree (B.Tech, 4 years, after Class 12) at institutes like NDRI Karnal. Lateral entry into B.Tech Dairy Technology is the standard route on from the diploma, though BIPE's first Dairy cohort entered in 2025-26 and is still mid-course." },
      { q: "Where do Dairy Engineering graduates work?", a: "Plant-floor and quality roles at Amul, Mother Dairy, Parag, Nestlé and NDDB. Junior Engineer cadres at State Dairy Federations are diploma-eligible. Self-employment is a real route too — small-scale dairy ventures built on the industrial-visit exposure and the six-month industrial training placement that Semester 6 mandates. BIPE's first Dairy cohort entered in 2025-26, so these are the routes ahead of them, not a placement record yet." },
      { q: "Are girls enrolled in Dairy Engineering at BIPE?", a: "Yes — the branch never carried a gender restriction and the 2025-26 cohort now finishing the diploma is co-ed. Dairy Engineering is closed to new admissions from 2026-27, so a girl applying today chooses from BIPE's four admitting branches, which are equally open to every applicant who clears JEECUP Group A and selects institute code 4455." },
      { q: "What is the starting salary after Dairy Engineering diploma?", a: "Plant-operator and quality-control roles at Amul, Mother Dairy and Parag start at ₹18,000-28,000/month for fresh diploma graduates. Junior Engineer (Dairy) roles at State Dairy Federations and NDDB start ₹30,000-40,000/month in-hand plus DA. After 3-5 years of plant experience, shift-engineer roles cross ₹45,000-55,000/month routinely. These are sector-wide figures for diploma entrants, not a BIPE placement record — the Dairy cohort admitted in 2025-26 is the branch's first and last, and it graduates in 2028." },
      { q: "What does the admissions closure mean for students already in the Dairy Engineering cohort?", a: "Nothing about their diploma changes. Classes, the chemistry and hydraulics labs, the industrial visits to working plants, the mandatory six-month Semester-6 industrial training and the BTEUP examination schedule all continue exactly as before, through to graduation in 2028, and the certificate awarded is the same BTEUP code-327 diploma it was always going to be. Its value in the job market does not depend on BIPE's intake decision either: the Indian dairy market is the world's largest by volume (235 million metric tonnes/year) and is still shifting from unorganised milkman supply to organised processed dairy — paneer, curd, ghee, ice-cream, condensed milk — which is what the Amul, NDDB and Parag hiring pipelines draw on." },
