...
export const CATCHMENTS: Catchment[] = [
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      {
        headline: "Civil and Electrical for the Vindhya infrastructure pipeline",
        body: "Mirzapur's sandstone belt, the NH-19 / NH-7 widening and the Bharatmala-linked corridor work running through the district all hire diploma-level site engineers, surveyors and supervisory staff. BIPE's Civil branch maps onto that work directly, and Electrical onto UPPCL's substation and JE recruitment across the Vindhya region — the two branches Mirzapur students most often convert into a first job close to home.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. BIPE and Government Polytechnic Mirzapur are both affiliated to BTE UP. The diploma certificate is identical — same paper, same authority, same legal weight for SSC JE / RRB JE / UPPCL eligibility. The difference lies in cohort size, mentor accessibility, placement infrastructure and how much individual attention a student actually gets.",
      },
      {
    ...
    governmentOption: {
      ...
      whenBipe:
        "BIPE wins when: (a) your JEECUP rank doesn't safely secure a government seat in the branch you want; (b) you want a smaller per-branch cohort with named faculty mentors instead of a large government section; (c) you're from outer Mirzapur tehsils and would need a hostel anyway; (d) you want documented placement infrastructure (1,363 named alumni). Honest comparison framework on /private-vs-government-polytechnic.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Electrical and Civil are the JE-exam routes Jaunpur families actually target",
    ...
    governmentOption: {
      ...
      whenBipe:
        "BIPE wins when: (a) your rank doesn't safely secure your branch at GP Jaunpur; (b) you want the Semester-5 onward SSC JE / RRB JE / UPPCL JE coaching that runs alongside the diploma; (c) you're from outer Jaunpur tehsils and need hostel; (d) you want denser placement-cell infrastructure. See /private-vs-government-polytechnic for the honest framework.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    branchAngle:
      "Civil for state PWD, Bharatmala / National Highway projects and the Purvanchal Expressway terminus at Haidaria; Electrical for UPPCL JE; Mechanical (Production) for Indian Railways and SSC JE; CSE for the central-government IT cadre route.",
    localContext:
      "Ghazipur has Government Polytechnic Ghazipur and a small private polytechnic ecosystem. For cost-binding families with a Ghazipur-domicile candidate scoring high enough in JEECUP for a government seat, that path remains the right choice. BIPE serves the Ghazipur families who want denser placement infrastructure, smaller cohorts or on-campus hostel residence.",
    transitNarrative:
    ...
    governmentOption: {
      ...
      description:
        "Ghazipur has a BTE UP–affiliated government polytechnic serving the district. Per-branch capacity is rank-limited via JEECUP counselling. Fees follow the standard UP government polytechnic structure (~₹12,000-22,000/year). Branches typically include Civil, Electrical and Mechanical — verify the current listing on the BTE UP portal.",
      whenGovernment:
      ...
      whenBipe:
        "BIPE wins for Ghazipur students when: (a) you want the structured JE-exam coaching and the on-campus placement drives that run from Semester 5 onward; (b) you need a hostel (80 km is too far for day-scholar); (c) your rank doesn't safely secure your preferred branch at the local government polytechnic. See /private-vs-government-polytechnic.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    branchAngle:
      "Mechanical (Production) for Azamgarh's textile + handloom machinery base; Civil for state-government engineering and infrastructure cadres; Electrical for UPPCL JE; CSE for government IT cadre exams.",
    localContext:
      "Azamgarh has Government Polytechnic Azamgarh and a handful of private polytechnic options. Government seats are limited and admission is rank-dependent through JEECUP. Many Azamgarh students who can't secure a government seat in the branch they want turn to BIPE Phoolpur. For families with cost as the primary constraint, government remains the right choice — see /private-vs-government-polytechnic for the framework.",
    transitNarrative:
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    governmentOption: {
      ...
      whenBipe:
        "BIPE wins for Mau students when: (a) the nearest government polytechnic option is in Azamgarh (~3 hours, hostel-required) — at that point you may as well hostel at BIPE with all four branches available; (b) you want the full branch portfolio under one JEECUP code rather than a single-branch bet; (c) you specifically want the 1,363 alumni placement track record. UP Post-Matric Scholarship is portable — BIPE assists with the application.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Civil and Electrical for the NH-19 corridor and UPPCL's JE cadres",
        body: "Bhadohi sits on the Varanasi–Prayagraj NH-19 corridor, where the widening work and the Bharatmala-linked feeder roads keep steady demand for diploma-level site and survey staff. Civil is the direct route into that; Electrical is the route into UPPCL's substation and JE recruitment. Both qualify a candidate for SSC JE and RRB JE — the fallback Bhadohi families most often want in hand when the carpet-export cycle turns soft.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    branchAngle:
      "Mechanical (Production) for RRB JE and Indian Railways technical cadres (the natural fit for Chandauli's DDU-anchored career culture); Civil for state PWD and agricultural infrastructure; Electrical for UPPCL and railway electrification; CSE for central-government IT cadre routes.",
    localContext:
      "Chandauli has Government Polytechnic Chandauli serving the district. The institute is BTE UP-affiliated and follows the standard UP government polytechnic fee structure. For Chandauli students with a strong JEECUP rank who want the standard 3-4 engineering branches and live in the city, the government route is the right choice. BIPE serves the broader Chandauli district — particularly outer-block students who need hostel access, and students who want a smaller per-branch cohort with named faculty mentors than the local government section can offer.",
    transitNarrative:
    ...
    governmentOption: {
      ...
      description:
        "Chandauli has its own BTE UP-affiliated government polytechnic serving the district. Standard UP government fee structure (~₹12,000-22,000/year). Branches typically include Civil, Electrical, Mechanical (verify current syllabus on BTE UP portal).",
      whenGovernment:
      ...
      whenBipe:
        "BIPE wins for Chandauli students when: (a) your rank doesn't safely secure your preferred branch at the local government polytechnic; (b) you want a smaller per-branch cohort with named faculty mentors; (c) you're from outer Chandauli blocks (Naugarh, Sakaldiha, Chakia) and need hostel; (d) you want documented placement infrastructure with named alumni at Indian Railways and 43 other recruiters. /private-vs-government-polytechnic has the wider framework.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Civil for the Ganga-bridge and expressway work on Ballia's doorstep",
        body: "The Ballia–Buxar Ganga bridge, the NH-31 upgrades and the Bharatmala-linked feeder roads coming down from the Purvanchal Expressway are live construction economies within an hour of home. Civil diploma holders are exactly who these projects hire as site engineers, surveyors and quantity staff — and the same qualification is the eligibility document for SSC JE (Civil) and state PWD recruitment.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Both BTE UP-affiliated, identical diploma. Government Polytechnic Ballia has lower fees and is a strong choice for cost-binding families with rank. BIPE's edge for Ballia students: hostel access (essential at 150 km), smaller cohort with named faculty mentors, documented placement record of 1,363 named alumni. See /private-vs-government-polytechnic for the framework.",
      },
      {
    ...
    governmentOption: {
      ...
      description:
        "Ballia has its own BTE UP-affiliated government polytechnic serving the district. Standard UP government polytechnic fee structure (~₹12,000-22,000/year). Branches typically include Civil, Electrical, Mechanical (verify current syllabus on BTE UP portal). The institute serves Ballia city and surrounding blocks well.",
      whenGovernment:
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Civil for the tribal-belt rural blocks and the district PWD pipeline",
        body: "Sonbhadra has a significant tribal population (Gond, Kharwar communities) and an agricultural base outside the industrial corridor. BIPE's Civil branch serves students from these rural blocks who target state-PWD, irrigation and rural-infrastructure work rather than the NTPC / Hindalco plant floor — and the same diploma is the eligibility document for SSC JE (Civil).",
      },
      {
    ...
    localContext:
      "Sonbhadra has Government Polytechnic Sonbhadra (Robertsganj) and a few smaller private options serving the district. Government polytechnic seats are rank-competitive given the strong industrial demand for technical diploma holders. BIPE serves Sonbhadra families who can't secure their preferred branch locally, or who want a denser placement-cell pipeline that includes private-industry recruiters alongside the regional government pathway.",
    transitNarrative:
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Civil for the Purvanchal Expressway corridor through Sultanpur",
        body: "The Purvanchal Expressway runs through Sultanpur district, and the feeder roads, service infrastructure and Bharatmala-linked upgrades that follow it are a live construction economy on the doorstep. BIPE's Civil branch is the diploma route into that work — NHAI contractors, state PWD and the private construction firms working the corridor — and the same qualification is the eligibility document for SSC JE (Civil).",
      },
      {
    ...
    branchAngle:
      "Civil for state PWD and the Bharatmala corridor through the Awadh region; Mechanical (Production) for Indian Railways RRB JE (the Sultanpur-Faizabad-Lucknow line is a major recruitment corridor); Electrical for UPPCL JE; CSE for central-government IT cadre exams.",
    localContext:
    ...
    governmentOption: {
      ...
      description:
        "Sultanpur has its own BTE UP-affiliated government polytechnic serving the district. Standard UP government fee structure (~₹12,000-22,000/year). Branches typically include Civil, Electrical, Mechanical (verify current syllabus on BTE UP portal).",
      whenGovernment:
      ...
      whenBipe:
        "BIPE wins for Sultanpur students when: (a) your rank doesn't safely secure the branch you want at the local government polytechnic; (b) you want a smaller per-branch cohort with named faculty mentors; (c) you're going to need hostel anywhere outside Sultanpur city anyway — BIPE has it on-campus; (d) you want the documented 1,363 alumni placement record across diverse recruiters.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Civil for the Awadh–Prayagraj corridor work",
        body: "Pratapgarh sits on the NH-128 / NH-31 corridor between Sultanpur and Prayagraj, and the Bharatmala-linked highway and bridge upgrades along it hire diploma-level site engineers, surveyors and supervisors. Civil is the direct route into that work and into state PWD — and for the mango and sugarcane belt it is also the branch behind the cold storage, godowns and rural roads that agro-processing actually depends on.",
      },
      {
        headline: "AFRC fees + scholarship for the typical Pratapgarh income band",
        body: "AFRC-approved tuition is ₹30,150/year. UP Post-Matric Scholarship reimburses tuition in full for eligible SC / ST candidates and in part for OBC / Minority / EWS candidates. For most Pratapgarh agricultural households, net out-of-pocket falls to ₹4,000-10,000/year — comparable to government polytechnic figures even before factoring in BIPE's wider rank band and four-branch portfolio.",
      },
    ],
    branchAngle:
      "Mechanical (Production) for Army Technical Entry + RRB JE (Pratapgarh's defence-recruit tradition); Electrical for UPPCL JE; Civil for state PWD and infrastructure work across the Awadh-Allahabad corridor; CSE for central-government IT cadres.",
    localContext:
      "Pratapgarh has Government Polytechnic Pratapgarh and a small private polytechnic ecosystem. For cost-binding families with confident JEECUP rank and Pratapgarh city residency, the government route is the obvious choice. Many Pratapgarh students who can't secure their preferred branch locally — or who want denser placement-cell support with hostel residence — turn to BIPE Phoolpur.",
    transitNarrative:
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Both BTE UP-affiliated, identical diploma. Government Polytechnic Pratapgarh has lower fees and is a strong choice for cost-binding families with rank. BIPE's edge: all four branches under one JEECUP code, on-campus hostel (essential at 170 km), 1,363 documented placements. See /private-vs-government-polytechnic for the framework.",
      },
    ],
    alumniNote:
    ...
    governmentOption: {
      ...
      description:
        "Pratapgarh has its own BTE UP-affiliated government polytechnic serving the district. Standard UP government polytechnic fee structure (~₹12,000-22,000/year). Branches typically include Civil, Electrical, Mechanical (verify current syllabus on BTE UP portal).",
      whenGovernment:
      ...
      whenBipe:
        "BIPE wins for Pratapgarh students when: (a) hostel is essential at any out-of-district polytechnic (and BIPE has one on-campus); (b) your rank doesn't safely secure the branch you want at the local government polytechnic; (c) you want the Semester-5 Army Technical Entry / RRB JE / SSC JE prep the career-counselling cell runs alongside the diploma; (d) you want the documented 1,363 alumni placement record across diverse recruiters.",
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    whyBipeReasons: [
      ...
      {
        headline: "Mechanical and Electrical for GIDA, HURL and the Gorakhpur Link Expressway",
        body: "Gorakhpur's industrial base has thickened — the revived HURL fertiliser plant, the GIDA industrial estate and the Gorakhpur Link Expressway tying the city into the Purvanchal corridor. Diploma-level technical staff are what these employers and their contractors hire, and Mechanical (Production) and Electrical are the branches that qualify a candidate for both those jobs and the RRB JE / SSC JE / UPPCL JE cadre exams.",
      },
      {
