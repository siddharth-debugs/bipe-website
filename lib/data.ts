...
export const DATA: DataShape = {
  ...
  faq: [
    ...
    { cat: "Hostel & Campus", q: "Is hostel available for girls?", a: "Yes. The campus has separate boys' and girls' hostel blocks with gender-specific wardens, staffed gates, visitor registration, fire safety, anti-ragging measures and a 9:30 PM curfew (extendable on parental authorisation)." },
