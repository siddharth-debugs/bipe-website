...
export const JEECUP_RESOURCES: JeecupResource[] = [
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. WhatsApp +91-9198767676 with your specific question — common ones include exam-centre choice, group selection, category certificate format, and fee payment troubleshooting. We don't charge for application counselling; the conversation is free and we'll answer in English or Hindi.",
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "BIPE doesn't have admin access to the JEECUP portal — only JEECUP's helpline can resolve portal-side issues. But our admissions counsellors can walk you through the download steps and help you escalate to the JEECUP helpline if needed. WhatsApp +91-9198767676.",
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "WhatsApp +91-9198767676 with your rank and preferred branch — our counsellors will walk you through the choice-filling order that maximises your odds at BIPE. The conversation is free and we'll answer in English or Hindi. We don't charge for guidance.",
      },
    ],
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "BIPE's spot round opens after Round 6 closes — typically late July / early August 2026. You visit BIPE Phoolpur in person with your JEECUP rank card and documents. The placement-cell desk reviews your rank against current vacancies and offers a seat if you qualify. Spot-round students join the same orientation as Round-1-6 students. WhatsApp +91-9198767676 to confirm spot-round dates before travelling.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Inform BIPE's admissions office immediately — WhatsApp +91-9198767676. We can often hold a provisional admission for 7-14 days while you complete the certificate at the tehsil. But you MUST flag this proactively; we can't help if you arrive on reporting day with no certificate and no notice.",
      },
      {
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    quickStats: [
      ...
      { label: "BIPE counsellor", value: "+91-9198646464 · call · +91-9198767676 · WhatsApp", sub: "EN / हिंदी" },
    ],
    contacts: {
      ...
      items: [
        ...
        { label: "BIPE counsellor (institute-side issues)", value: "+91-9198646464 (call) · +91-9198767676 (WhatsApp) · EN / हिंदी", href: "https://wa.me/919198767676" },
    ...
    ctaBody: "For BIPE-specific questions — choice-filling strategy, document checklists, branch-by-branch fit, when to visit — WhatsApp +91-9198767676. Free, no enrolment pressure, EN / हिंदी.",
  },
...

  {
    ...
    ctaBody: "BIPE's admissions team has helped 1,000+ students through JEECUP prep. WhatsApp +91-9198767676 with your current preparation level (started · midway · pre-exam) and we'll send a free 30/60/90-day study plan tailored to your timeline.",
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    ctaBody: "Our academic mentors have analysed JEECUP papers 2020-2025 and produced a topic-weightage chart + sample answer sheets. WhatsApp +91-9198767676 and we'll share the PDF — free, no enrolment pressure, no email gate.",
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    ctaBody: "WhatsApp +91-9198767676 with your Class 10 status (cleared / appearing / pending) and your state of residence — BIPE's admissions team will confirm eligibility within 10 minutes. Free, no enrolment pressure, EN / हिंदी.",
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    ctaBody: "BIPE shares 2 mock JEECUP CBT tests (Group A) free via WhatsApp ahead of every cycle. Simulates the real interface · 100 questions · 150 minutes · answer key included. WhatsApp +91-9198767676 to request — no enrolment pressure.",
  },
  ...
  // ─────────────────────────────────────────────────────────────────
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes, via direct admission for vacant seats. BIPE accepts direct applications after JEECUP Round 6 concludes (typically August). Available seats vary by branch + year. WhatsApp +91-9198767676 in August 2026 to check current-cycle vacancy. Direct admission isn't rank-restricted but is seat-limited.",
      },
      {
    ...
    ctaBody: "WhatsApp +91-9198767676 with your rank, branch preferences, and home district within 48 hours. BIPE's admissions counsellor gives a free 10-minute honest interpretation — whether BIPE 4455 fits your rank, and how to optimise your counselling choice list to maximise the right outcome.",
  },
];
