...
export const ROUTES: Record<RouteKey, {
  ...
  apply: {
    ...
    description: "Apply to BIPE Phoolpur 2026-27 free · 5 minutes · JEECUP 4455. Counsellor call within 24 hrs. हिंदी / English WhatsApp +91-9005882866.",
  ...
  contact: {
    ...
    title: "Contact BIPE · +91-9005882866 · info@bipe.ac.in · Phoolpur Varanasi",
    description: "Call BIPE: +91-9005882866 · WhatsApp: +91-9005882866 · info@bipe.ac.in · Gajokhar, Phoolpur, Varanasi 221206. हिंदी / English.",
