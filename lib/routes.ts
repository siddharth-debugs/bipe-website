...
export const ROUTES: Record<RouteKey, {
  ...
  home: {
    ...
    description: "Top polytechnic & engineering college in Varanasi — BIPE is AICTE-approved with 5 BTEUP diploma branches including rare Dairy Engineering. JEECUP 4455. 2026-27 admission closed — enquire for 2027-28.",
    keywords: [
      "BIPE Varanasi",
